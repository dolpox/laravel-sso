...
```shell
$ php artisan vendor:publish --provider="Dolpox\LaravelSSO\SSOServiceProvider"
```
...
Edit your `app/Http/Kernel.php` by adding `\Dolpox\LaravelSSO\Middleware\SSOAutoLogin::class` middleware to `web` middleware group. It should look like this:
```php
protected $middlewareGroups = [
        'web' => [
            ...
            \Dolpox\LaravelSSO\Middleware\SSOAutoLogin::class,
        ],
...
{
    $broker = new \Dolpox\LaravelSSO\LaravelSSOBroker;
